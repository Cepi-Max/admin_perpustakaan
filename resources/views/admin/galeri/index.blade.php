    ...
    <div x-data="galleryViewer()" class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="deleteSelected" x-show="selectedCount > 0"
            ...
            @if ($galeris->count() > 0)
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                    @foreach ($galeris as $index => $galeri)
                        <div
                            class="group relative bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-105">
                            <!-- Image Container -->
                            <div class="relative aspect-square overflow-hidden">
                                <img src="{{ asset('storage/' . $galeri->gambar) }}" alt="{{ $galeri->judul }}"
                                    ...
                                    @click="openPopup({{ $index }})" loading="lazy"
                            ...
                            <i class="bi bi-zoom-in text-white text-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></i>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-1">
                                        ...
                                        <button type="button" @click="deleteOne({{ $galeri->id }})"
        ...
        <div x-show="showDeleteModal" x-transition class="fixed inset-0 z-50 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
                <div class="fixed inset-0 transition-opacity bg-black bg-opacity-50" @click="showDeleteModal = false">
                </div>
            ...
            function galleryViewer() {
                return {
                    ...
                    deleteSelected() {
                        ...
                        this.deleteMessage =
                            `Apakah Anda yakin ingin menghapus ${checkedBoxes.length} gambar yang dipilih? Tindakan ini tidak dapat dibatalkan.`;
                        this.deleteAction = () => {
